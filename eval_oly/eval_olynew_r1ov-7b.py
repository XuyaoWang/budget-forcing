...
for wait in range(7):
    ...
    for subset in subset_list:
        file_path = f"/home/hansirui_2nd/pcwen_workspace/s1m_assemble/result/r1-ov-7b-30168_{subset}-{wait}wait.json"
...
# 将结果保存为JSON文件
output_file = "/home/hansirui_2nd/pcwen_workspace/s1m_assemble/scores/r1-ov-7b_oly_results.json"
