...
# 分析结果
model_7b_result_dir = "R1-Onevision-7B-RL-mathv_evaluation_results.json"
model_7b_results = anaylze_results(model_7b_result_dir)
model_7b_results.sort(key=lambda x: x["num_ignore"])

model_38b_result_dir = "Skywork-R1V-38B-mathv_evaluation_results.json"
...
# 保存为PNG格式
plt.savefig(os.path.join(SAVE_DIR, 'Math_Vision_comparison_results.png'), dpi=300, bbox_inches='tight')
